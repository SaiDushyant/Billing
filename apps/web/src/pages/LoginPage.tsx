    ...
    <div className="min-h-screen w-full relative bg-[#F8FAFC] flex items-center justify-center p-4 md:p-8 overflow-hidden font-sans">
      ...
      <div className="absolute top-0 left-0 w-full h-full pointer-events-none overflow-hidden z-0">
        ...
        <div className="absolute bottom-0 left-0 right-0 w-full overflow-hidden leading-[0] opacity-40">
          <svg viewBox="0 0 1440 220" className="relative block w-full h-[180px] text-blue-100" preserveAspectRatio="none">
            <path d="M0,120 C320,200 640,160 960,100 C1280,40 1380,80 1440,100 L1440,220 L0,220 Z" fill="currentColor" opacity="0.6" />
            <path d="M0,150 C400,220 800,140 1200,160 L1440,130 L1440,220 L0,220 Z" fill="currentColor" opacity="0.4" />
          </svg>
        </div>
      </div>
      ...
      <div className="w-full max-w-6xl grid grid-cols-1 md:grid-cols-12 gap-8 items-center z-10 relative">
        ...
        <div className="md:col-span-6 flex flex-col items-center text-center px-4">
          ...
          <div className="flex items-center gap-3 mb-2">
            <svg className="w-11 h-11 text-blue-600" viewBox="0 0 48 48" fill="none">
              {/* Hexagonal Outer Frame */}
              <path d="M24 4L40 13.2V31.8L24 41L8 31.8V13.2L24 4Z" fill="#2563EB" stroke="#2563EB" strokeWidth="2.5" strokeLinejoin="round" />
              {/* White isometric box inside */}
              <path d="M24 14L34 19.5V29.5L24 35L14 29.5V19.5L24 14Z" fill="white" />
              {/* Isometric lines on the box */}
              <path d="M24 14V35" stroke="#2563EB" strokeWidth="1.5" />
              <path d="M14 19.5L24 25L34 19.5" stroke="#2563EB" strokeWidth="1.5" />
            </svg>
          ...
          <div className="w-full max-w-md hidden md:block animate-float-svg">
            <svg className="w-full h-auto drop-shadow-[0_10px_25px_rgba(59,130,246,0.02)]" viewBox="0 0 500 330" fill="none" xmlns="http://www.w3.org/2000/svg">
              {/* Browser Window Backdrop */}
              <rect x="130" y="60" width="240" height="175" rx="12" fill="white" stroke="#E2E8F0" strokeWidth="1.5" />
              
              {/* Browser Top Header */}
              <path d="M130.75 60.75 H369.25 Q369.25 60.75 369.25 78 V78 H130.75 Z" fill="#F8FAFC" stroke="#E2E8F0" strokeWidth="1.5" />
              
              {/* Browser Address Bar Pill */}
              <rect x="185" y="66" width="130" height="8" rx="4" fill="#EDF2F7" />
              ...
              <line x1="145" y1="120" x2="280" y2="120" stroke="#F1F5F9" strokeWidth="1.5" strokeDasharray="3 3" />
              <line x1="145" y1="150" x2="280" y2="150" stroke="#F1F5F9" strokeWidth="1.5" strokeDasharray="3 3" />
              <line x1="145" y1="180" x2="280" y2="180" stroke="#F1F5F9" strokeWidth="1.5" strokeDasharray="3 3" />
              ...
              {/* Filled Chart Area */}
              <path d="M145 190 Q170 180 185 150 T220 170 T255 110 T280 120 V200 H145 Z" fill="url(#chartGrad)" />
              
              {/* Spline Stroke Line */}
              <path d="M145 190 Q170 180 185 150 T220 170 T255 110 T280 120" stroke="#3B82F6" strokeWidth="3" strokeLinecap="round" />
              
              {/* Glowing Line Nodes */}
              <circle cx="185" cy="150" r="3" fill="#3B82F6" stroke="white" strokeWidth="1" />
              <circle cx="220" cy="170" r="3" fill="#3B82F6" stroke="white" strokeWidth="1" />
              <circle cx="255" cy="110" r="3" fill="#3B82F6" stroke="white" strokeWidth="1" />
              
              {/* Simple Donut Chart inside Browser */}
              <circle cx="325" cy="115" r="18" stroke="#F1F5F9" strokeWidth="4.5" fill="none" />
              <circle cx="325" cy="115" r="18" stroke="#3B82F6" strokeWidth="4.5" strokeDasharray="80 115" strokeLinecap="round" fill="none" transform="rotate(-90 325 115)" />
              <text x="325" y="118" textAnchor="middle" fill="#475569" fontSize="8" fontWeight="bold">70%</text>
              <rect x="305" y="145" width="40" height="4" rx="2" fill="#E2E8F0" />
              <rect x="315" y="153" width="20" height="4" rx="2" fill="#3B82F6" />

              {/* Simple Tabs inside Browser */}
              <rect x="145" y="90" width="30" height="10" rx="3" fill="#EFF6FF" />
              <rect x="180" y="90" width="30" height="10" rx="3" fill="#F1F5F9" />
              
              {/* Flat Outline Calculator Widget (Left) */}
              <rect x="50" y="180" width="45" height="60" rx="8" fill="white" stroke="#E2E8F0" strokeWidth="1.5" />
              <rect x="56" y="186" width="33" height="10" rx="2" fill="#F8FAFC" stroke="#E2E8F0" />
              <circle cx="61" cy="205" r="2" fill="#E2E8F0" /><circle cx="69" cy="205" r="2" fill="#E2E8F0" /><circle cx="77" cy="205" r="2" fill="#E2E8F0" /><circle cx="85" cy="205" r="2" fill="#3B82F6" />
              <circle cx="61" cy="213" r="2" fill="#E2E8F0" /><circle cx="69" cy="213" r="2" fill="#E2E8F0" /><circle cx="77" cy="213" r="2" fill="#E2E8F0" /><circle cx="85" cy="213" r="2" fill="#E2E8F0" />
              <circle cx="61" cy="221" r="2" fill="#E2E8F0" /><circle cx="69" cy="221" r="2" fill="#E2E8F0" /><circle cx="77" cy="221" r="2" fill="#E2E8F0" /><circle cx="85" cy="221" r="2" fill="#E2E8F0" />
              <circle cx="61" cy="229" r="2" fill="#E2E8F0" /><circle cx="69" cy="229" r="2" fill="#E2E8F0" /><circle cx="77" cy="229" r="2" fill="#E2E8F0" /><circle cx="85" cy="229" r="2" fill="#E2E8F0" />
              
              {/* Flat Outline Invoice Document Widget (Middle-Left) */}
              <rect x="75" y="125" width="70" height="90" rx="8" fill="white" stroke="#E2E8F0" strokeWidth="1.5" />
              {/* Invoice lines */}
              <rect x="85" y="152" width="22" height="3" rx="1.5" fill="#E2E8F0" />
              <rect x="85" y="160" width="30" height="3" rx="1.5" fill="#E2E8F0" />
              <rect x="85" y="180" width="40" height="4" rx="2" fill="#1E293B" />
              {/* Rupee Circle Badge */}
              <circle cx="95" cy="140" r="10" fill="#EFF6FF" stroke="#DBEAFE" strokeWidth="1" />
              <text x="95" y="144" textAnchor="middle" fill="#3B82F6" fontSize="12" fontWeight="bold">₹</text>
              {/* Status Badge */}
              <rect x="115" y="136" width="22" height="8" rx="4" fill="#ECFDF5" />
              <text x="126" y="142" textAnchor="middle" fill="#10B981" fontSize="5" fontWeight="bold">Paid</text>
              
              {/* Flat Delivery Box Widget (Right) */}
              <rect x="360" y="170" width="70" height="55" rx="8" fill="white" stroke="#E2E8F0" strokeWidth="1.5" />
              <rect x="368" y="178" width="18" height="18" rx="4" fill="#FFFBEB" stroke="#FEF3C7" strokeWidth="1" />
              <path d="M377 182 L381 184.5 V189.5 L377 192 L373 189.5 V184.5 L377 182 Z" fill="#F59E0B" />
              <rect x="392" y="181" width="22" height="4" rx="2" fill="#1E293B" />
              <rect x="392" y="189" width="14" height="3" rx="1.5" fill="#E2E8F0" />
        ...
        <div className="md:col-span-6 flex justify-center md:justify-end px-2">
          ...
          <div className="bg-white px-6 py-8 md:p-10 rounded-3xl w-full max-w-[460px] shadow-[0_15px_40px_rgba(59,130,246,0.06)] border border-slate-100 flex flex-col relative z-20">
                ...
                <label className="flex items-center gap-2 cursor-pointer select-none group">
                  <div className="relative flex items-center justify-center">
                    ...
                    <div className="w-5 h-5 rounded-md border border-slate-200 bg-white transition-all peer-checked:bg-blue-600 peer-checked:border-blue-600 group-hover:border-slate-300 flex items-center justify-center text-white">
                      <svg className="w-3.5 h-3.5 transform scale-0 peer-checked:scale-100 transition-transform duration-150" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round">
            ...
            <div className="text-center mt-7 text-slate-500 text-sm font-semibold">
              ...
              <Link to="/signup" className="text-blue-600 hover:text-blue-700 font-extrabold transition-colors duration-200 ml-1">
                Signup
              </Link>
            </div>
